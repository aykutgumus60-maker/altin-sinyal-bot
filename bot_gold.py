...
# AYARLAR
# ------------------------------------------------------------------
SYMBOL = os.environ.get("SYMBOL", "PAXGUSDT")
INTERVAL = "5m"
...
CRSI_THRESHOLD = float(os.environ.get("CRSI_THRESHOLD", 20))
UO_THRESHOLD = float(os.environ.get("UO_THRESHOLD", 40))
...
MFI_THRESHOLD = float(os.environ.get("MFI_THRESHOLD", 25))
...
RVI_SAT_THRESHOLD = float(os.environ.get("RVI_SAT_THRESHOLD", 75))
...
STATE_FILE = os.path.join(os.path.dirname(__file__), "state_gold.json")
