"""
ALTIN (PAXGUSDT) - 180 GUNLUK GERIYE DONUK TEST
==================================================
Bu script bot_gold.py'yi kullanir, bot.py veya backtest.py'ye HIC
dokunmaz - BTC botunu etkilemez, tamamen bagimsiz calisir.

Calistirmak icin (GitHub Actions ile):
  Actions -> "ALTIN (PAXG) Backtest (180 gun)" -> Run workflow

Yerelde calistirmak icin:
  python backtest_gold.py            (varsayilan 180 gun)
  python backtest_gold.py 90
"""
...
from bot_gold import (
    ...
    MAJORITY_THRESHOLD, MFI_THRESHOLD,
)
...
def main():
    ...
    print("\n=== HER INDIKATORUN TEK BASINA ESIK ALTINA DUSME SIKLIGI (ALTIN) ===")
    ...
    signals.to_csv("gold_signals_180gun.csv", index=False)
    ...
    print("\nDetayli liste 'gold_signals_180gun.csv' dosyasina yazildi.")
